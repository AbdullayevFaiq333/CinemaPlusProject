...
namespace DataAccessLayer.Interfaces
{
    public interface IRepository<T> where T: class, IEntity
    {
        ...
        Task<List<T>> GetAllAsync(Expression<Func<T, bool>> expression,List<string> ingludedProperties=null);
        Task<T> GetAsync(int id);
        Task<T> GetAsync(Expression<Func<T,bool>> expression, List<string> ingludedProperties = null);
